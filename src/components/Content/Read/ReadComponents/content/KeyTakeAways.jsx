...
const KeyTakeAways = ({ key_takeaways }) => {
        ...
        onClick={() => {
          {
            direction === 'left'
              ? setCurrent(
                  (current - 1 + key_takeaways.length) % key_takeaways.length
                )
  ...
  return (
    <div
      className=" lg:col-span-1 border-blueLike text-zinc-600 dark:text-zinc-200 flex justify-center items-center mx-5"
      ref={KTref}
    >
      <div
        href="#"
        className={` w-full pt-6 drop-shadow-xl bg-zinc-100 border-gray-200 sm:min-h-[300px] lg:min-h-[500px] rounded-lg shadow-md flex justify-between ${
      ...
      >
        <div>
          <div className="flex flex-col  justify-between items-center ">
            <div
              className={`flex flex-row items-center border-b border-gray-200 pb-1 justify-center px-2 w-full ${
          ...
          <div className="text-l mt-10 px-8 object-fit:contain">
            {keysCollapsed ? (
              ...
              key_takeaways.map((item, index) => (
                <p
                  key={index}
                  className={'border-b border-slate-200 pb-5 pt-5'}
                >
                  {'• '}
                  {item}
                </p>
        ...
        <button
          onClick={handleClick}
          className={
            'text-gray-500 underline hover:text-zinc-200 font-light_ text-sm mt-5 mb-10'
          }
        >
