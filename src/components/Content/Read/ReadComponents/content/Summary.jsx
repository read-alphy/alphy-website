...
const Summary = ({
  ...
  if (summaryArray.length === 0) {
    return (
      <div className="overflow-auto text-l text-slate-500 dark:text-slate-200 quicksand font-bold max-w-screen-md mx-auto text-center flex flex-col rounded-lg">
