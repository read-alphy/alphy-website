...
{currentUser ? (
              ...
              <div className="w-full items-center">
                ...
                >
                  <button className=" absolute bottom-4 normal-case bg-green-200 dark:bg-white transition duration-200 ease-in focus:ring-4 focus:outline-none focus:ring-blue-200 dark:focus:ring-blue-900 font-averta-semibold drop-shadow-sm rounded-lg  px-5 py-3 inline-flex justify-center w-full text-center text-zinc-700 text-[16px]">
