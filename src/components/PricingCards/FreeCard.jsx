...
export default function FreeCard({ tier, currentUser }) {
    ...
    return (
        <div className="col-span-1 xs:max-w-[400px] xs:min-w-[400px] xl:max-w-[360px] xl:min-w-[270px] p-4 bg-white border border-gray-200 rounded-lg  drop-shadow-sm  sm:p-8 dark:bg-zinc-900 dark:drop-shadow-xl dark:border-gray-700  ">
            ...
            <p className="mb-4 text-2xl  text-gray-500 dark:text-zinc-300 font-averta-semibold">Starter</p>

            <div className="flex items-baseline text-gray-900 dark:text-white">

                <span className="text-5xl  tracking-tight font-averta-semibold">Free</span>

            </div>
            <p className="mt-3 text-gray-400 font-averta-semibold">Discover Alphy's capabilities </p>
                ...
                <ul role="list" className="space-y-5 my-7">
                    {
                        ...
                        (currentUser ?
                            <a target="_blank" href={tier !== "free" && "https://billing.stripe.com/p/login/bIYdTS2Qs9CscfuaEE"}>
                                <Button type="button" className={` bg-zinc-700  transition duration-200 ease-in ${tier !== "free" ? "bg-zinc-700  dark:bg-darkMode dark:bg-zinc-700 text-zinc-300" : "pointer-events-none text-zinc-700"} rounded-lg text-[16px] font-averta-semibold px-5 py-3 inline-flex text-zinc-100 justify-center w-full text-center`}>{currentUser ? (tier !== "free" ? "Go Starter" : "Active") : "Sign Up For Free"}</Button>
                            </a>
                            :
                            <div className="w-full items-center">
                                <Link to="/u/login" type="button" className="items-center w-full">
                                    ...
                                    <Button className="text-white bg-greenColor transition duration-200 ease-in focus:ring-4 focus:outline-none focus:ring-blue-200 dark:focus:ring-blue-900 font-averta-semibold rounded-lg  px-5 py-3 inline-flex justify-center w-full text-center text-zinc-700 text-[16px]">{currentUser ? "Active" : "Sign Up For Free"}</Button></Link>
                            </div>
                        )
                    ...
                    <li className="flex mt-20 space-x-3">
                        ...
                        <span className="text-base font-averta-semibold leading-tight text-gray-500 dark:text-zinc-300">Access Alphy's public database</span>
                    </li>
                    <li className="flex space-x-3">

                        <svg aria-hidden="true" className="flex-shrink-0 w-5 h-5 text-gray-200 dark:text-zinc-200" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><title>Check icon</title><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path></svg>
                        <span className="text-base font-averta-semibold leading-tight text-gray-500 dark:text-zinc-300">1 hour transcription credits for YouTube videos</span>
                    </li>

                    <li className="flex space-x-3">
                        <svg aria-hidden="true" className="flex-shrink-0 w-5 h-5 text-gray-200 dark:text-zinc-200" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><title>Check icon</title><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path></svg>
                        <span className="text-base font-averta-semibold leading-tight text-gray-500 dark:text-zinc-300">Create 1 Arc</span>
                    </li>
