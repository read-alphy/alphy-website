...
export default function PremiumCard({
  ...
  return (
    <div className="col-span-2  xs:max-w-[400px] xs:min-w-[400px] xl:max-w-[360px] xl:min-w-[270px] p-4 border border-gray-200 transform *-translate-y-2* rounded-lg drop-shadow-xl sm:p-8 bg-gradient-to-br from-white to-slate-50 dark:from-gray-900 dark:to-gray-700 dark:bg-gradient-to-br dark:drop-shadow-xl dark:border-gray-700 ">
        ...
        <ul role="list" className="space-y-5 my-7">
          <Shine puffyness="0.5">
            <Button
              ...
              type="button"
              className={` bg-gradient-to-l from-green-100 to-green-300   transition duration-200 ease-in ${
                tier === 'premium' ? 'pointer-events-none text-whiteLike' : ''
              } rounded-lg text-[16px] font-averta-semibold px-5 py-3 inline-flex text-zinc-700 justify-center w-full text-center`}
            >
          ...
          <li className="flex space-x-3">
            ...
            <Popover>
              <PopoverHandler>
                <span className="text-base font-averta-semibold leading-tight text-gray-500 dark:text-zinc-300 underline  dashedcursor-pointer">
                  GPT-4 Access
                </span>
              </PopoverHandler>
              <ThemeProvider value={themePopover}>
                <PopoverContent>
                  <p className="text-zinc-600 dark:text-zinc-300">
                    Your submissions will be processed by the most advanced AI
                    model on the market.
                  </p>
                </PopoverContent>
              </ThemeProvider>
