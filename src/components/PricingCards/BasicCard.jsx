...
>
                <Button type="button" className={`transition duration-200 ease-in ${tier==="basic"  && "pointer-events-none bg-zinc-700 text-white "} ${tier==="free" && "bg-greenColor text-zinc-700 "} ${tier==="premium" && "bg-zinc-700 text-white"} rounded-lg text-[16px] font-semibold px-5 py-3 inline-flex justify-center w-full text-center`} >
...
>
                <Button type="button" className={`transition duration-200 ease-in ${tier==="basic"  && "pointer-events-none bg-zinc-700 text-white "} ${tier==="free" && "bg-greenColor text-zinc-700 "} ${tier==="premium" && "bg-zinc-700 text-white"} rounded-lg text-[16px] font-semibold px-5 py-3 inline-flex justify-center w-full text-center`} >
                    ...
                    <li className="flex space-x-3">
                        ...
                        <span className="text-base font-normal leading-tight text-gray-500 dark:text-zinc-300">Extra 5 hours of prioritized transcription credits per month</span>
                    </li>
