		...
		<footer class="p-4 sm:p-6 ">
			<div class="container md:flex md:justify-between mx-auto">
				<div class="mb-6 md:mb-0 ml-100">
					...
					<p className="text-l font-semibold whitespace-nowrap dark:text-white">
						<br />
						Feel free to reach us through <span className="text-yellow-600"> info@alphy.tech</span> or ping
						us on our Discord for any questions and feedback.
					</p>
				</div>
				<div class="grid grid-cols-1 gap-8 sm:gap-6 sm:grid-cols-1">
					<div>
						<h2 class="mb-6 mt-4 text-sm font-semibold text-gray-900 uppercase dark:text-white">
							Reach us
						</h2>
						<ul class="text-gray-600 dark:text-gray-400">
							<li class="mb-4">
								<a href="mailto:info@alphy.tech" class="hover:underline ">
									info@alphy.tech
								</a>
							</li>
							<li class="mb-4">
