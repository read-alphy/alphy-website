...
function Footer() {
  return (
    ...
    <footer
      className={
        'p-4 sm:p-6 flex flex-col  justify-center items-center w-full text-mainText dark:bg-mildDarkMode bg-bordoLike'
      }
    >
      <hr className={'my-6 bg-bordoLike sm:mx-auto lg:my-8 '} />
      <div
        className={
          'container lg:flex lg:justify-between  mx-auto max-w-[1200px]'
        }
      >
        <div className={'mb-6 md:mb-0 '}>
          ...
          <p className="text-l font-semibold md:whitespace-nowrap">
            ...
            <a href="mailto:support@alphy.app">
              <span className="text-green-300 hover:text-green-300 cursor-pointer ">
                {' '}
                support@alphy.app
              </span>{' '}
            </a>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-1 mb-5">
          <div>
            <h2 className="mb-6  text-2xl text-whiteLike font-bold ">
              Related Links
            </h2>
          </div>
