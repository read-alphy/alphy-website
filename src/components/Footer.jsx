...
function Footer() {
	return (
		...
		<footer class="p-4 sm:p-6 flex flex-col justify center items-center text-mainText bg-blueLike">
			<hr class="my-6 border-gray-200 sm:mx-auto lg:my-8" />
			<div class="container md:flex md:justify-between mx-auto">
				<div class="mb-6 md:mb-0 ml-100">
					<a href="https://flowbite.com/" class="flex items-center">
						<span class="self-center text-2xl font-semibold whitespace-nowrap">Alphy</span>
					</a>
