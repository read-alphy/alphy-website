                ...
                {currentUser && (
                  <div className="flex flex-col">
                    <Link
                      href="/history"
                      className={`${
                        router.asPath.includes("/history") ? "text-zinc-700 dark:text-zinc-200" : "text-zinc-500 dark:text-zinc-300"} flex flex-row py-3 mt-2  text-sm sm:text-md  -pr-0.5  hover:text-zinc-500 dark:hover:text-zinc-100 transition duration-300 ease-in-out`}
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
