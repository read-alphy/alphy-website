...
export default function FreeCard({ tier, currentUser }) {
  ...
  return (
    <div className="col-span-1 xs:max-w-[400px] xs:min-w-[400px] xl:max-w-[360px] xl:min-w-[270px] p-4 bg-white border border-zinc-700 rounded-lg    sm:p-8 dark:bg-zinc-900  dark:border-gray-700  ">
      ...
      <p className="mt-3 text-zinc-500 quicksand">Discover Alphy's capabilities </p>
      <div className="h-[720px] relative ">
        ...
        <li className="flex space-x-3">
            ...
            <span className="text-base quicksand font-bold leading-tight text-gray-500 dark:text-zinc-300">
          ...
          <li className="flex space-x-3">
            ...
            {/* <span className="text-base quicksand font-bold leading-tight text-gray-500 dark:text-zinc-300">Optional credit top ups</span> */}
            <span className="text-base quicksand font-bold leading-tight text-gray-500 dark:text-zinc-300">
          ...
          {/*                <li className="flex space-x-3">
                        ...
                        <span className="text-base quicksand font-bold leading-tight text-gray-500 dark:text-zinc-300"> Content popularity limit </span>
 ...
 */}
      ...
      {currentUser ? (
          ...
          <li className="flex space-x-3 pt-4">
            <span className="text-base quicksand font-bold leading-tight text-gray-500 dark:text-zinc-300"></span>
          </li>
        </ul>
      </div>
    </div>
