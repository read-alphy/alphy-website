...
export default function FreeCard({ tier, currentUser }) {
  ...
  return (
    <div className="col-span-1 xs:max-w-[400px] xs:min-w-[400px] xl:max-w-[360px] xl:min-w-[270px] p-4 bg-white border border-zinc-700 rounded-lg    sm:p-8 dark:bg-zinc-900  dark:border-gray-700  ">
      <p className="mb-4 text-2xl  text-zinc-900 dark:text-zinc-300 quicksand font-bold">
        Starter
      </p>

      <div className="flex items-baseline text-gray-900 dark:text-white">
        <span className="text-5xl  tracking-tight quicksand font-bold">
          Free
        </span>
      </div>
      <p className="mt-3 text-slate-400 quicksand font-semibold">Discover Alphy's capabilities </p>
      <div className="h-[720px] relative ">
        ...
        <li className="flex space-x-3">
            ...
            <span className="text-base quicksand font-bold leading-tight text-slate-600 dark:text-zinc-300">
          ...
          <li className="flex space-x-3">
            ...
            {/* <span className="text-base quicksand font-bold leading-tight text-slate-400 dark:text-zinc-300">Optional credit top ups</span> */}
            <span className="text-base quicksand font-bold leading-tight text-slate-400 dark:text-zinc-300">
          ...
          {/*                <li className="flex space-x-3">
                        ...
                        <span className="text-base quicksand font-bold leading-tight text-slate-400 dark:text-zinc-300"> Content popularity limit </span>
                            <PopoverHandler {...triggers1} >
                            <svg className="w-5 h-5 pt-1 opacity-50 text-gray-400 hover:text-slate-400" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-8-3a1 1 0 00-.867.5 1 1 0 11-1.731-1A3 3 0 0113 8a3.001 3.001 0 01-2 2.83V11a1 1 0 11-2 0v-1a1 1 0 011-1 1 1 0 100-2zm0 8a1 1 0 100-2 1 1 0 000 2z" clipRule="evenodd"></path></svg>
                            </PopoverHandler>
      ...
      {currentUser ? (
              ...
              >
                <Button
                  ...
                  } normal-case rounded-lg text-[16px] quicksand font-bold px-5 py-3 inline-flex text-zinc-100 justify-center w-full text-center`}
                >
                  {currentUser
                    ? tier !== 'free'
                      ? 'Downgrade  '
              ...
              <div className="w-full items-center">
                ...
                >
                  <button className=" absolute bottom-4 normal-case bg-green-200 dark:bg-white transition duration-200 ease-in focus:ring-4 focus:outline-none focus:ring-blue-200 dark:focus:ring-blue-900 quicksand font-bold drop-shadow-sm rounded-lg  px-5 py-3 inline-flex justify-center w-full text-center text-zinc-700 text-[16px]">
          ...
          <li className="flex space-x-3 pt-4">
            <span className="text-base quicksand font-bold leading-tight text-slate-400 dark:text-zinc-300"></span>
          </li>
        </ul>
      </div>
    </div>
