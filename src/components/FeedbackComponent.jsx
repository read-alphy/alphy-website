    ...
    px-4 py-3`}>
        {showFeedbackTally === false ?
            <div className="flex flex-col text-center items-center ">
                        ...
                        <p className="hidden group-hover:block mt-4 dark:text-whiteLike"> Fill out this 3-min survey about your experience with Alphy so far and win <span className="underline dark:text-whiteLike font-bold">1 hour</span> in transcription credits! </p>
