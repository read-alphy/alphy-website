    ...
    <div className="w-full h-full container xl:max-w-[1000px] 2xl:max-w-[1280px] mx-auto pb-20">
      ...
      <div className="relative ">
        <button
          ...
          ref={leftButtonRef}
          type="button"
          className={`left-arrow absolute top-0 left-0 z-30 flex items-center justify-center h-full cursor-pointer group focus:outline-none ${
        ...
        <button
          ...
          ref={rightButtonRef}
          type="button"
          className={`right-arrow absolute top-0 right-0 z-30 flex items-center justify-center h-full cursor-pointer group focus:outline-none ${
