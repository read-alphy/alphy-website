				...
				<div className="flex flex-col flex-grow ">
					<div className={`flex items-center font-bold pt-8 relative`}>
						...
						<div className="hidden md:block">
							...
							<svg onClick={() => setCollapsed(true)} xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="feather feather-chevron-left ml-16  text-zinc-500 dark:text-zinc-500 cursor-pointer rounded-full hover:bg-gray-200 dark:hover:bg-zinc-700 hover:transition hover:duration-200 hover:ease-in-out p-1"><polyline points="15 18 9 12 15 6"></polyline></svg>
						</div>
					...
					<div className="">
								...
								<div className="flex-row flex">
									...
									<div className="absolute z-50 pl-1 pt-1">
										<button className="opacity-0 hover:opacity-100 hover:text-zinc-100 dark:hover:text-zinc-100 hover:block text-zinc-500 dark:text-zinc-500 cursor-pointer rounded-full hover:bg-green-300 dark:hover:bg-green-300 hover:transition  hover:ease-in-out duration-300 p-1 ">
											...
											<svg onClick={() => setCollapsed(true)} className="feather feather-chevron-left  rotate-180" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" ><polyline points="15 18 9 12 15 6"></polyline></svg>
						...
						<div className="pt-16 ">
							...
							<div className="flex flex-col w-full justify-start ">
								<div className="pl-2">
									<Link to="/submit" className={`text-zinc-700 transition duration-300 ease-in-out rounded-full bg-zinc-200 px-2 py-1.5 dark:bg-zinc-100 text-md`} >
								...
								<Link to="/" className={` pl-4 text-zinc-500 dark:text-zinc-300 flex flex-row py-3 mt-6 dark:text-zinc-300 hover:text-zinc-600 dark:hover:text-zinc-200 transition duration-300 ease-in-out`} >
									<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none"
										...
										stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-compass"><circle cx="12" cy="12" r="10"></circle><polygon points="16.24 7.76 14.12 14.12 7.76 16.24 9.88 9.88 16.24 7.76"></polygon></svg>
