                                ...
                                <PopoverContent className="dark:bg-mildDarkMode dark:border-zinc-500 dark:border-darkMode"  >
                                    <div className="">
                                        <div className="">
                                            ...
                                            {(data.source_type === "up" && (data !== undefined && data !== null && (currentUser !== null && data.submitter_id == currentUser.uid))) &&
                                                <div>
                                                    ...
                                                    <div className="relative flex flex-row  group  cursor-default">
                                                        <div className=" flex flex-row text-zinc-600 dark:text-zinc-300 items-center z-[9999]">
                                                            ...
                                                            <span className="text-sm mx-2 font-averta-semibold">{isVisible === true ? "Public" : "Private"}</span>
                                                        </div>
                                                        ...
                                                        {tier === "premium" &&
                                                            <span className="absolute opacity-0 min-w-[200px] font-averta-semibold  group-hover:opacity-100 transform group-hover:scale-100 transition-all duration-500 ease-in-out bg-white dark:bg-zinc-800 drop-shadow-lg text-zinc-500 dark:text-gray-300 text-sm rounded py-1 px-2 md:top-full z-[9999] mb-2 ml-4">
                                                                {isVisible ? "Toggle the visibility of this content. Switching to private makes it accessible only by you." : "Toggle the visibility of this content. Switching to public makes it accessible by all."}
                                                            </span>
                                                        }
                                                        {tier !== "premium" &&
                                            ...
                                            <div className="flex flex-row mb-2	 items-center hover:opacity-80 dark:hover:opacity-80 ">
                                                ...
                                                <p onClick={handleBookmark} className="text-center items-center flex text-zinc-700 dark:text-zinc-200 opacity-80 cursor-pointer font-averta-semibold">
                                                    ...
                                                    {currentUser && isBookmarked && (currentUser && data && data.submitter_id !== currentUser.uid) &&
                                                        <BookmarkRemoveIcon />
                                                    }
                                                    {isBookmarked === false && (currentUser && data && data.submitter_id !== currentUser.uid) &&
                                                        <BookmarkAddIcon />}

                                                    {currentUser && isBookmarked === true && (currentUser && data && data.submitter_id !== currentUser.uid) && <span className="ml-2 font-averta-semibold">Remove Bookmark</span>}
                                                    {currentUser && isBookmarked === false && (currentUser && data && data.submitter_id !== currentUser.uid) && <span className="ml-2 font-averta-semibold">Add To Bookmarks</span>}
                                                </p>
                                            </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="relative flex flex-row  group  cursor-default">
                                            <div className=" flex flex-row text-zinc-600 dark:text-zinc-300 items-center z-[9999]">
                                                ...
                                                <AntSwitch onChange={handleVisibility} defaultChecked={isVisible} disabled={tier !== "premium"} />
                                                <span className="text-sm mx-2">{isVisible === true ? "Public" : "Private"}</span>
                                            </div>
                                ...
                                {(currentUser && data && data.submitter_id !== currentUser.uid) &&
                                    <div className="flex flex-row mb-5 items-center hover:opacity-80 dark:hover:opacity-80 ">
                                        ...
                                        <p onClick={handleBookmark} className="text-center items-center flex text-zinc-700 dark:text-zinc-200 opacity-80 cursor-pointer">
                                            ...
                                            {currentUser && isBookmarked === true && <span className="ml-2 text-zinc-600 dark:text-zinc-300 opacity-80 items-center text-md font-averta-semibold">Remove Bookmark</span>}
                                            {currentUser && isBookmarked === false && <span className="ml-2 text-zinc-600 dark:text-zinc-300 opacity-80 items-center text-md font-averta-semibold">Add Bookmark</span>}
                                        </p>
                                    </div>
                                }
                                {(currentUser && data && data.submitter_id !== currentUser.uid) ?
