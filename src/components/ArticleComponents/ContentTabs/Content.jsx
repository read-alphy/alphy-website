...
export default function Content({
  ...
  return (
    <div
      ref={ref}
      className={`md:max-w-[100vw] scroll-smooth pb-10 md:px-10 ${isSandbox=== true ? "ml-0" : "md:ml-6"}  xl:px-20  3xl:px-40  mt-5 md:mt-0  mx-auto 3xl:mx-0 overflow-x-hidden   md:pt-20 h-full lg:min-h-[100vh] lg:max-h-[100vh] overflow-y-auto`}
    >
      <div
