export const inputMessages = [
  ...
  {
    command_type: 'video_clips',
    message:
      'Give me the most noteworthy parts of the conversation worth of video clips.',
  },
  {
    command_type: 'youtube_shorts',
    message:
      'Give me the moments from the conversation that would go well as YouTube Shorts.',
  },
  {
