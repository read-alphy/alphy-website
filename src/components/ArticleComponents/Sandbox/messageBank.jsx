...
const twitter_thread=  (<TwitterIcon
...
const audiogram= <GraphicEqIcon className="row-span-1" sx={{ color: '#818cf8' }} />


const youtube_shorts= (<YouTubeIcon
  className="row-span-1"
  fontSize="medium"
  sx={{ color: '#dc2626' }}
/>)
...
const investment_analysis=  <CurrencyBitcoinIcon
className="row-span-1"
sx={{ color: '#ef8e19' }}
/>
const newsletter_generator=  <EmailIcon
className="row-span-1"
fontSize="medium"
sx={{ color: `${theme === 'light' ? '#64748b' : '#cbd5e1'}` }}
/>
const highlight_generator=  <HighlightIcon
className="row-span-1"
fontSize="medium"
sx={{ color: '#facc15' }}
/>
...
const video_topic_generator=  <YouTubeIcon
className="row-span-1"
fontSize="medium"
sx={{ color: '#dc2626' }}
/>

const video_description= <YouTubeIcon
className="row-span-1"
fontSize="medium"
sx={{ color: '#dc2626' }}
/>
...
const space_idea_generator= <MicIcon
className="row-span-1"
fontSize="medium"
sx={{ color: '#7366d7' }}
/>
...
const space_description_generator= <MicIcon
className="row-span-1"
fontSize="medium"
sx={{ color: '#7366d7' }}
/>
...
const keyword_identifier= <GoogleIcon
className="row-span-1"
fontSize="medium"
sx={{ color: `${theme === 'light' ? '#64748b' : '#cbd5e1'}` }}
/>
...
const get_actionables= <ChecklistRtlIcon
className="row-span-1"
fontSize="medium"
...
const generate_quizzes=  <QuizIcon
className="row-span-1"
fontSize="medium"
sx={{ color: `${theme === 'light' ? '#64748b' : '#cbd5e1'}` }}
/>

const executive_brief_composer=  <WorkIcon
className="row-span-1"
fontSize="medium"
...
const investment_insight_extractor=  <ShowChartIcon
className="row-span-1"
fontSize="medium"
