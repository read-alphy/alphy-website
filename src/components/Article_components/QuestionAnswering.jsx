            ...
            <div className='Md:pl-10 md:pr-10 pt-10'>
                ...
                <div className="flex items-center">
                    ...
                    <div class="relative w-full">
                        ...
                        <input value={inputValue} onClick={() => handleClick(true)} onChange={(event) => setInputValue(event.target.value)} onKeyDown={handleKeyDown} type="text" id="search" className={`block w-full p-4 pl-10 text-sm text-zinc-500 placeholder:text-zinc-90   ${signedInError && inputValue.length === 0 ? "border-2 border-red-900" : "border border-zinc-200"} placeholder:italic rounded-lg bg-whiteLike focus:outline-none`} placeholder="Ask anything to the transcript..." autoComplete="off" required />
