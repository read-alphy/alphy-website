...
export default function QuestionAnswering(source_id, key_qa, data) {
    ...
    const [isLoading, setIsLoading] = useState(source_id?.length === 0);
    const [optionValue, setOptionValue] = useState("")

    console.log(source_id.length)
            ...
            <div className='pl-10 pr-10 pt-10'>
                ...
                <div className="flex items-center">
                    ...
                    <div class="relative w-full">
                        ...
                        <input value={inputValue} onClick={() => handleClick(true)} onChange={(event) => setInputValue(event.target.value)} onKeyDown={handleKeyDown} type="text" id="search" className=" block w-full p-4 pl-10 text-sm text-zinc-500 placeholder:text-zinc-90  border border-zinc-200 placeholder:italic rounded-lg bg-whiteLike focus:outline-none" placeholder="Ex: How does X work? What are the best practices for taking notes?" autoComplete="off" required />
