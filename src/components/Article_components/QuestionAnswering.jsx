            ...
            <div className='pl-10 pr-10 pt-10'>
                ...
                <div className="mt-20">
                    ...
                    {isCleared ?
                        ...
                        (<button className="mx-auto text-zinc-700"><svg aria-hidden="true" fill="none" width="30px" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
