    ...
    return (
        <div className="mx-auto w-800 flex justify-center text-blueLike bg-zinc-100">
            ...
            <div id="about" className="px-4 container w-5/6 max-w-4xl pt-20 pb-20 text-l lg:text-l">
                ...
                <br></br>
                <p> Alphy aims to help users meaningfully interact with the speech-based information on the Internet with the help of artificial intelligence. It transcribes and summarizes audio-based content and offers semantic research on the transcript to allow users navigate the content with ease.
                </p>
                <br></br>
                <br></br>
                <h2 className="lg:text-xl  font-semibold"> What can I do with Alphy?</h2>
                <br></br>
                <p>• You can do semantic research on the video transcript, meaning that you can ask questions or search for a specific topic and get the most relevant answers presented by the content.
                    ...
                    <br></br><br></br>• As YouTube and Twitter don't provide the best auto-generated transcripts, you can also get a decent transcript with Alphy.</p>
                <br></br>
                <br></br>
