      ...
      <div className="main-page-feed-table-parent bg-slate-50 border-[1px] border-[#0b090a] rounded-[10px] sm:p-[40px] p-[10px]">
        ...
        <form class="flex items-center">
          ...
          <div class="relative w-full">
            <input type="text" onChange={(e) => setSearchText(e.target.value)} id="voice-search" class="bg-slate-100 border border-bordoLike text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-5 p-2.5" placeholder="Search YouTube videos or Twitter spaces..." required />
          </div>
          <button type="submit" class="inline-flex items-center py-2.5 px-3 ml-2 text-sm font-medium text-whiteLike bg-orangeLike rounded-lg border border-bordoLike hover:bg-purpleLike focus:ring-4 focus:outline-none focus:ring-blue-300">
