    ...
    return (
        ...
        <div id="detailed-pricing" class="w-full mx-auto  container items-center flex flex-wrap max-w-[1000px] overflow-x-auto">
            <div class="overflow-hidden min-w-max border-4 border-blueLike">
                <div class="grid grid-cols-3 p-4 text-sm font-medium text-gray-900 bg-gray-100 border-t border-b border-gray-200 gap-x-16 dark:bg-gray-800 dark:bg-zinc-900 dark:drop-shadow-xl dark:border-gray-700 dark:text-white">
                    <div class="flex items-center"></div>
                    <div className="">                    <h5 class="mb-4 text-2xl font-medium text-gray-500 dark:text-zinc-300">Free</h5>
                    ...
                    <div>                    <h5 class="mb-4 text-xl font-medium text-gray-500 dark:text-zinc-300">Premium</h5>
                ...
                <div class="grid grid-cols-3 px-4 py-5 text-sm text-gray-700 dark:text-zinc-300 border-b border-gray-200 gap-x-16 dark:border-gray-700">
                    <div class="text-gray-500 dark:text-zinc-300">Basic components (<a href="#" class="text-blue-600 hover:underline">view all</a>)</div>
                    <div>
                ...
                <div class="grid grid-cols-3 px-4 py-5 text-sm text-gray-700 dark:text-zinc-300 border-b border-gray-200 gap-x-16 dark:border-gray-700">
                    <div class="text-gray-500 dark:text-zinc-300">Application UI (<a href="#" class="text-blue-600 hover:underline">view demo</a>)</div>
                    <div>
                ...
                <div class="grid grid-cols-3 px-4 py-5 text-sm text-gray-700 dark:text-zinc-300 border-b border-gray-200 gap-x-16 dark:border-gray-700">
                    <div class="text-gray-500 dark:text-zinc-300">Marketing UI pre-order</div>
                    <div>
                        <svg class="w-5 h-5 text-red-500" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                    </div>
                    <div>
                ...
                <div class="grid grid-cols-3 px-4 py-5 text-sm text-gray-700 dark:text-zinc-300 border-b border-gray-200 gap-x-16 dark:border-gray-700">
                    <div class="text-gray-500 dark:text-zinc-300">E-commerce UI pre-order</div>
                    <div>
                        <svg class="w-5 h-5 text-red-500" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                    </div>
                    <div>
                ...
                <div class="grid grid-cols-3 px-4 py-5 text-sm text-gray-700 dark:text-zinc-300 border-b border-gray-200 gap-x-16 dark:border-gray-700">
                    <div class="text-gray-500 dark:text-zinc-300"></div>
                    <div>
