        ...
        {sandboxHistory &&
          sandboxHistory.map((item, index) => (
            <div
              ...
              key={index}
              >
                <div className="hover:brightness-[125%] transition  duration-300 ease-in-out">
              <div className="flex flex-row gap-6 items-center relative w-full  ">
                ...
                />
                <p className="text-xl text-zinc-700 dark:text-zinc-300 font-averta-semibold select-none ">
                  {item.title}
                </p>
                ...
                >
                  <ReactMarkdown>{item.response}</ReactMarkdown>
                        ...
                        <div
                          ...
                          >
                            <button
                              className="text-blue-900 flex flex-row font-averta-semibold text-sm dark:text-white right-0 absolute px-2 py-2 rounded-lg bg-sky-100 dark:bg-indigo-400"
                              onClick={event => {
                            ...
                            >
                            <p> See On Source</p>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 mt-1 ml-1">
