...
function Success({ currentUser, collapsed, setCollapsed, tier, customerID, credit, userArchipelagos, dataGlobalArchipelagos, setDataGlobalArchipelagos, getDataGlobalArchipelagos }) {
