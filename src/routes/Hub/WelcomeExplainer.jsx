      ...
      <div className="w-full  mx-auto  md:pl-10  lg:pl-16 xl:pl-20 3xl:pl-40  overflow-hidden pb-10">
        <div className="pl-5 pr-5 mt-4  sm:mt-10 lg:mt-20 ">
          {totalMinutes > 0 && (
            <div className="flex flex-row ">
              <p className="bg-gradient-to-r from-pink-200 to-amber-100 via-red-200 rounded-lg px-2 py-1   font-bold text-zinc-900 text-md xs:text-lg">
                ...
                <span className="font-averta-regular text-sm xs:text-lg">
          ...
          <p className="text-zinc-900 dark:text-zinc-300 mb-5 mt-4 mx-auto text-3xl xs:text-4xl text-[30px]   font-bold  ">
            Save time and learn better from audiovisual content.
          </p>
          <p className="text-zinc-500 dark:text-zinc-400 mb-5  mt-4 text-lg xs:text-xl lg:text-xl font-averta-regular font-normal max-w-[600px]">
            {' '}
            Join the Alphy community to transcribe, summarize, and ask questions
            to online and offline audiovisual content.
          </p>
          <div className={`mt-8 flex flex-row`}>
            <Link
              to={`${currentUser ? '/submit' : '/u/register'}`}
              className={`rounded-lg  text-zinc-800  text-center text-md sm:text-md bg-[radial-gradient(ellipse_at_bottom_right,_var(--tw-gradient-stops))] from-teal-50 to-teal-100  px-4 py-3 font-averta-semibold drop-shadow-sm ${
                currentUser ? 'w-[200px]' : 'w-[150px]'
              }`}
            >
              {currentUser
            ...
            {currentUser ? (
              <Link
                to="/myhub"
                className="rounded-lg  text-zinc-800  text-center text-md sm:text-md bg-none border border-zinc-700 dark:border-zinc-500 dark:text-zinc-300 ml-4  px-4 py-3 font-averta-semibold drop-shadow-sm w-[150px]"
              >
              ...
              <Link
                to="/explore"
                className="rounded-lg  text-zinc-800  text-center text-md sm:text-md bg-none border border-zinc-700 dark:border-zinc-500 dark:text-zinc-300 ml-4  px-4 py-3 font-averta-semibold drop-shadow-sm "
              >
            ...
            <div className="flex flex-col text-zinc-700 dark:text-zinc-300 font-averta-bold text-lg mt-16 md:mt-24">
              ...
              <div className="flex flex-row mt-4 sm:mt-8 gap-y-4 opacity-80 overflow-scroll">
                <img
                  ...
                  width={135}
                  title="YouTube"
                  className="sm:mr-4 lg:mr-10 w-1/6 sm:w-2/12 lg:w-1/3 mx-2 max-w-[160px]"
                />
                <img
                  src={Twitter}
                  height={20}
                  ...
                  className="  sm:mr-4 lg:mr-10 w-1/6 sm:w-2/12 lg:w-1/3  px-2 max-w-[130px]"
                />
                <img
                  src={Spaces}
                  height={20}
                ...
                <img
                  ...
                  height={20}
                  width={80}
                  className="sm:mr-4 lg:mr-10 justify-center sm:w-2/12 w-1/6 lg:w-1/3  px-2 max-w-[130px]"
                />
                <img
                  src={ApplePodcast}
                  height={20}
                  ...
                  className=" justify-center  sm:mr-4 lg:mr-10 w-1/6 sm:w-2/12 lg:w-1/3  px-2 max-w-[130px]"
                />
              </div>
            </div>
          </Shine>
