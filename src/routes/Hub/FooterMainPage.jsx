                ...
                <div className="">
                    <div className="flex flex-col">
                        ...
                        {localStorage.getItem("logged in") === "true" ?
                            ...
                            <Link className="text-zinc-500  mt-2 lg:mt-4 dark:text-zinc-300 text-sm w-full cursor-pointer w-full pl-6 md:pl-10 " to="/account">
                                {/* <PersonIcon className="text-zinc-300 mr-2" fontSize="medium"/> */}
                                <span className="font-averta-semibold">Account</span>
                            </Link> :

                            <Link className="text-zinc-500 dark:text-zinc-300 mt-2 lg:mt-4 text-sm w-full cursor-pointer w-full pl-6 md:pl-10 " to="/plans">
