                ...
                (mainShow=="default" ?
                    <div className="pt-10 md:pt-20 pb-10 overflow-x-hidden ">
                      <div className="pl-4 sm:hidden mb-20 ">
                           ...
                           <p className="text-zinc-700 dark:text-zinc-300 mb-5 mx-auto mt-4 text-xl font-semibold">Unlock the information in audiovisual content with Alphy.</p>
                           <p className="text-zinc-700 dark:text-zinc-300 mb-5 mx-auto mt-4 text-md">Process an online conversation, upload an audio file, or create a chatbot on Alphy's database.</p>
                          ...
                          {/*  <Link to="/submit" className={`text-zinc-700  transition duration-300 ease-in-out ${submitLayout ? " drop-shadow-sm ":"drop-shadow-lg  scale-105 transform"}   bg-green-200 text-zinc-600 dark:text-zinc-700 rounded-lg px-2 text-md max-w-[120px] flex flex-row py-2`} >
                                ...
                                <Link to="/submit" onClick={() => {localStorage.setItem("newItem", "link")}} className="rounded-lg text-zinc-600  text-sm xs:text-md bg-green-100 px-2 py-2  font-sans font-semibold drop-shadow-md">Submit a Link
                                </Link>
                            <Link to="/submit" onClick={() => {localStorage.setItem("newItem", "upload")}} className="rounded-lg text-zinc-600 text-sm xs:text-md bg-indigo-100 px-2 py-2  font-sans font-semibold drop-shadow-md">Upload A File</Link>
                           <Link to="/arc/createArc" className="rounded-lg text-zinc-600 text-sm xs:text-md bg-red-100 px-2 py-2 font-sans font-semibold drop-shadow-md">Create an Arc</Link> 
