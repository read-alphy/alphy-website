    ...
    return(
        ...
        <div className="col-span-2 flex justify-start  min-w-[300px]">
            ...
            placeholder="Set a title..."
							onChange={(event) => setArchipelagoTitle(event.target.value)} className="w-full  font-averta-semibold text-l px-2 h-[50px] bg-white dark:bg-mildDarkMode border border-zinc-200 dark:border-zinc-700 focus:border-greenColor focus:outline-none focus:ring-0 rounded-lg"/>
...
<p className="text-zinc-700 dark:text-zinc-300 mb-2 mt-16 ml-1 font-averta-semibold">Description</p>
                <textarea className={`min-h-[120px] rounded-lg font-averta-semibold bg-white border-zinc-200 dark:border-zinc-700 dark:bg-mildDarkMode resize-none text-sm w-full text-top focus:border-greenColor focus:outline-none focus:ring-0`} 
...
<div>
            ...
            <div className="col-span-3 grid-row-2 flex justify-start  lg:p-10 drop-shadow-sm">
                ...
                <p className="mt-20 lg:mt-5 ml-2 text-lg font-bold text-zinc-700 dark:text-zinc-300 font-averta-semibold">{archipelagoTitle.length>0 ? archipelagoTitle:"Arc"}</p>
     ...
     {errorMessage && dataArchipelago.length===0 && <p className="mt-4 ml-2 mb-5 text-md text-red-500 dark:text-red-400 opacity-80 font-averta-semibold">An Arc cannot be empty. Please add an item to continue.</p>}
