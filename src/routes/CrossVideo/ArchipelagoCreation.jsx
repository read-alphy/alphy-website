        ...
        <div className=" w-full min-w-[300px] ">
          <div className="flex flex-col ">
            ...
            <div className="w-full">
              ...
              <textarea
                className={`min-h-[120px] rounded-lg font-averta-semibold bg-white border-zinc-200 dark:border-zinc-700 dark:bg-mildDarkMode resize-none text-sm w-full text-top focus:border-greenColor focus:outline-none focus:ring-0`}
